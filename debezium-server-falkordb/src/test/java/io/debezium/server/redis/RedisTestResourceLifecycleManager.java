...
public class RedisTestResourceLifecycleManager implements QuarkusTestResourceLifecycleManager {
    ...
    private static final FixedHostPortGenericContainer<?> container = new FixedHostPortGenericContainer<>("registry.hub.docker.com/falkordb/falkordb")
    ...
    public Map<String, String> start() {
        ...
        params.put("debezium.sink.type", "falkordb");
        params.put("debezium.sink.falkordb.address", RedisTestResourceLifecycleManager.getRedisContainerAddress());
